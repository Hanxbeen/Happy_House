...
<div class="container">
  ...
  <div class="form">
    <div class="sign-in" id="sign-in-info">
      ...
      <form id="sign-in-form" method = "post" action= "${root }/main?action=login">
        <input type="text" name="memName" placeholder="Name"/>
        <input type="password"name="memPwd"  placeholder="Password"/>
<!--         <p class="forgot-password">Forgot your password?</p> -->
         <a class="forgot-password" href="admin.jsp">admin page</a>     
        
        <input type = "submit" class="control-button in" value="ㅇㅇㅇ"/>
      </form>
    </div>
...
<script type="text/javascript">var overlay = document.getElementById("overlay");
...
openSignInButton.addEventListener("click", openSignIn, false);</script>
</body>
</html>